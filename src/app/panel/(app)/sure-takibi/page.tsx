...
import { durationDays, projectCategoryTr, stageStatusTr } from "@/lib/portal/labels";
    ...
    <div className="mx-auto max-w-3xl space-y-8">
      <div>
        ...
        <p className="mt-2 text-muted">
          Yol haritası adımlarının başlangıç / bitiş tarihleri ve süreleri (gün).
        </p>
      </div>
                    ...
                    return (
                      <li key={item.id} className="relative pb-5 last:pb-0">
                        ...
                        <div className="rounded-xl border border-border bg-surface/80 px-4 py-3.5">
                          <p className="font-display text-sm font-semibold tracking-tight text-primary sm:text-base">
                            {item.title}
                          </p>
                          <dl className="mt-3 grid gap-2 text-sm sm:grid-cols-3">
                            ...
                            <div>
                              ...
                              <dd className="mt-0.5 font-medium text-accent">{days} gün</dd>
                            </div>
                          </dl>
                          {item.note.trim() ? (
                ...
                <div className="space-y-2">
                  ...
                  <ul className="grid gap-2 sm:grid-cols-2">
                    {p.stages.map((s) => {
                      ...
                      const days =
                        start != null ? durationDays(start, end) : null;
                      return (
                        <li
                          key={s.id}
